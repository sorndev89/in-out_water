...
class Load_page extends CI_Controller {
	...
	public function index()
	{
		...
		switch ($page) {
			...
			break;
			case 'search':  //// Show Search All -------------------
			$data = $this->input->post('data');
			//if($data!=''){ $this->show_in_out = $this->In_outv2->search_doc("document",$data);  } 
			//	else{ 
			//$this->show_in_out = $this->In_outv2->show_data_docall("document"); }
			...
			$year = $this->input->post('year');
			//echo $search_kine;
			if($search_kine=='all'){ $this->show_in_out = $this->In_outv2->search_doc("document",$data,$year);  }
			else {
			...
			$this->sh_ooffice = $this->In_outv2->show_data("other_office");
			$this->sh_set = $this->In_outv2->show_data("setting_data");
			///$this->load->view('cr_report_data',$this); 
			//echo $this->data_report;
			//echo $this->sh_gno_in;
			...
			//$sh_gno_out = $this->show_re_day;
			//foreach($sh_gno_out  as $grono){ 
			//		echo $grono['name'];
			//}
	...
	public function preview($file='')
	{
		...
		/*
		echo '<div>
		    <object data="http://127.0.0.1/in-outv2/file_upload/20170327113616.pdf" type="application/pdf" width="80%" height="800">

...
(function() {
    ...
    // ==============================
    // Standard Dialogs
    demo("#alertify-alertd", function(ev) {
        alertify.alert("This is an alert dialog");
        return false;
    });

    demo("#alertify-confirm", function(ev) {
        alertify.confirm("This is a confirm dialog222", function(ev) {
            ev.preventDefault();
    ...
    demo("#alertify-ajax", function(ev) {
        alertify.confirm("Confirm?www", function(ev) {
            ev.preventDefault();
            alertify.alert("Successful AJAX afterddd OK");
        }, function(ev) {
            ev.preventDefault();
            alertify.alert("Successful AJAX afterfff Cancel");
        });
    });
